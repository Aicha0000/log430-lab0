# ADR-003: Stratégie de persistance des données: PostgreSQL & SQLite
...
## Décision
PostgreSQL pour la maison mère & SQLiteavec pour les magasins avec l'application du Repository Pattern uniquement pour abstraire l'accès aux données (voir ADR 005-patron.md)

## Alternatives considérées
PostgreSQL central pour données de référence et rapports + SQLite local par magasin pour autonomie opérationnelle. La synchronisatioin se fait via APIs et webhooks.
